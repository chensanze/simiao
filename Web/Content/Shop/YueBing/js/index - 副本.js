(function ($) {
    ...
    $.stone.setmyAmount = function (obj, flag) {
        var $Amount = $(".goods_activity_input_Amount");
        var a = $Amount.val();
        switch(flag)
        {
            case "+":
                $Amount.val(parseInt(a) + parseInt(1));
                break;
            case "-":
                if (parseInt(a) > 1) $Amount.val(parseInt(a) - parseInt(1));
                break;
        }
    }
